...
const settingDefinitions: Record<string, SettingDef> = {
  ...
  payment_flutterwave_client_id: { label: "Flutterwave Client ID", type: "text", description: "Your Flutterwave V4 Client ID", section: "Flutterwave API", placeholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" },
  payment_flutterwave_client_secret: { label: "Flutterwave Client Secret", type: "password", description: "Keep this secret — never share it", section: "Flutterwave API", placeholder: "••••••••" },
  payment_flutterwave_encryption_key: { label: "Flutterwave Encryption Key", type: "password", description: "Used for encrypting sensitive payment data", section: "Flutterwave API", placeholder: "••••••••" },
