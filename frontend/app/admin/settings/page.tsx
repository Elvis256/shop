...
const settingDefinitions: Record<string, SettingDef> = {
  ...
  payment_flutterwave_public_key: { label: "Flutterwave Public Key", type: "text", description: "Your Flutterwave V3 Public Key (FLWPUBK-...)", section: "Flutterwave API", placeholder: "FLWPUBK-xxxxxxxxxxxxxxxx-X" },
  payment_flutterwave_secret_key: { label: "Flutterwave Secret Key", type: "password", description: "Keep this secret — never share it", section: "Flutterwave API", placeholder: "••••••••" },
