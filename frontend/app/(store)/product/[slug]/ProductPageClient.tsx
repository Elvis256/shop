...
import { Star, Heart, Shield, Truck, Package, ArrowLeft, Share2, Check, Eye, Users, ShoppingBag } from "lucide-react";
      ...
      <div className="container py-4">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-10">
          ...
          <div className="h-fit">
            ...
            {viewerCount > 1 && (
              <div className="flex items-center gap-2 mb-4 px-3 py-2 bg-orange-50 rounded-lg text-sm text-orange-700">
