      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl p-8 prose prose-gray max-w-none">
          ...
          <ul>
            ...
            <li>Limited employee access to customer information</li>
          ...
          <p>
            Our products are intended for adults only (18+). By using our website, 
            you confirm that you meet the legal age requirement in your jurisdiction.
          </p>

          <h2>Data Retention</h2>
          <p>
            We retain your personal information for as long as necessary to provide 
            our services and comply with legal obligations. Order history is retained 
            for 7 years for tax and legal purposes.
          </p>
